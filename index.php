...
<table class="design">
<tr>
<td align="center">Benutzername:</td><td align="center"><input style="width:207px; border-radius: 5px;" name="benutzer"></td>
</tr>
<tr>
<td align="right">Passwort:</td><td align="center"><input type="password" style="width:207px; border-radius: 5px;" name="passwort"></td>
</tr>
<tr>
<td align="right"></td><td align="right"><input type="submit" value="Anmelden" name="l_button" ></td>
	...
	<button type="button" name="gotoregister" id="gotoregister_button" class="gotoregister-button" style="width:150px; height:26px;float: right;margin-right: 41px; margin-bottom: 10px;margin-top: 10px;"
        onclick="window.location=\'registrierung.php\';">
		<span class="gotoregister_button" style="font-size:20px; float:right; margin-top:-1px"></span>
		<span class="button-caption" style="margin-top:1px; float:right">Registrierung</span>
	</button>
